 ...
 */
package com.api.healthcare.components;
...
public class PasswordHash
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            // Print out 10 hashes
            for(int i = 0; i < 10; i++)
                System.out.println(pbkdf2.createHash("p\r\nassw0Rd!"));
            ...
            for(int i = 0; i < 100; i++)
            {
                ...
                String secondHash = pbkdf2.createHash(password);
                if(hash.equals(secondHash)) {
                    System.out.println("FAILURE: TWO HASHES ARE EQUAL!");
                    failure = true;
                }
                String wrongPassword = ""+(i+1);
                if(pbkdf2.validatePassword(wrongPassword, hash)) {
                    System.out.println("FAILURE: WRONG PASSWORD ACCEPTED!");
                    failure = true;
                }
                if(!pbkdf2.validatePassword(password, hash)) {
